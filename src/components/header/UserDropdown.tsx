...
//           fetch(`http://localhost:5000/api/crypto/getgeneralinfo/${session.user.email}`),
//           fetch(`http://localhost:5000/api/crypto/getprofileimage/${session.user.email}`),
//         ]);

//         const infoData = await infoRes.json();
//         const imageData = await imageRes.json();

//         if (infoData?.fullName) setFullName(infoData.fullName);
//         if (imageData?.imageUrl) setProfileImage(imageData.imageUrl);
//       } catch (error) {
...
//   />
//         </span>
//         <span className="block mr-1 font-medium text-theme-sm">{fullName.split(" ")[0]}</span>
//         <svg
//           className={`stroke-gray-500 dark:stroke-gray-400 transition-transform duration-200 ${
//             isOpen ? "rotate-180" : ""
//           }`}
...
//         {/* Your Dropdown Items */}
//         {/* Keep your dropdown list items here as you already have them. */}
//         {/* Example: */}
//         <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
//           <li>
