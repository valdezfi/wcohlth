    ...
    const fetchOrders = async () => {
      try {
        const endpoint = user?.email
          ? `http://localhost:5000/api/crypto/getallsellerorders/${user.email}`
          : `http://localhost:5000/api/crypto/getallUSDT`;
    ...
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
      <div className="max-w-full overflow-x-auto">
        <Table className="text-[16px] leading-relaxed">
          <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
              <TableCell isHeader className="px-5 py-3 font-semibold text-gray-600 text-start text-[14px] dark:text-gray-300">
                {/* Seller */}
              </TableCell>
              <TableCell isHeader className="px-5 py-3 font-semibold text-gray-600 text-start text-[14px] dark:text-gray-300">
                {/* Pay */}
              </TableCell>
              <TableCell isHeader className="px-5 py-3 font-semibold text-gray-600 text-center text-[14px] dark:text-gray-300">
                {/* Receive */}
              </TableCell>
            </TableRow>
          </TableHeader>
